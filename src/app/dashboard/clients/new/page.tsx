...
export default function NewClientPage() {
    ...
    async function onSubmit(data: ClientFormValues) {
        ...
        try {
            ...
            router.refresh(); // To refetch clients on the list page
        } catch (error: any) {
                        ...
                        <div className="space-y-6">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input id="emailAddress" type="email" placeholder="Contact email address..." className="bg-gray-50 mt-1" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            {isCompanyAlertVisible && (
                                <Alert className="bg-cyan-50 border-cyan-200 text-cyan-900 [&>svg]:text-cyan-600 relative p-4">
                                    ...
                                    <Button variant="ghost" size="icon" type="button" className="absolute top-1.5 right-1.5 h-7 w-7 text-cyan-900 hover:bg-cyan-100" onClick={() => setCompanyAlertVisible(false)}>
                                        <X className="h-4 w-4" />
                                    </Button>
                                </Alert>
                            )}
                                    ...
                                    <FormItem>
                                        <Label htmlFor="phoneNumber" className="font-semibold text-gray-700">Phone Number (optional)</Label>
                                         <div className="flex items-center mt-1">
                                            ...
                                            <FormControl>
                                                <Input id="phoneNumber" type="tel" placeholder="(415) 555-1212" className="rounded-l-none bg-gray-50" {...field} />
                                            </FormControl>
                                        </div>
                                        <FormMessage />
                                    </FormItem>
